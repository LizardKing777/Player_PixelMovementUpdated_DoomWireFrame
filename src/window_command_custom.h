...
#ifndef EP_WINDOW_COMMAND_CUSTOM_H
#define EP_WINDOW_COMMAND_CUSTOM_H
 ...
 */
class Window_Command_Custom : public Window_Command {
public:
	/**
	 * Constructor.
	 *
	 ...
	 */
	Window_Command_Custom(Scene* parent, std::vector<std::string> commands, int width = -1, int c = 1);
